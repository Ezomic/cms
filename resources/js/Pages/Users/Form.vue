...
interface Data { id: number; name: string; email: string }
        ...
        <form class="max-w-md" @submit.prevent="submit">
            <Card>
                <CardContent class="flex flex-col gap-4">
                    ...
                    <p class="text-xs text-muted-foreground">No password: new admins sign in with an emailed one-time code, then register a passkey.</p>
                </CardContent>
            </Card>
        </form>
    </AdminLayout>
