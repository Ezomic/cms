...
const src = computed<string | null>(() => candidates.value[index.value] ?? null);
...
<template>
    ...
    >
        <img v-if="showIcon" :src="src!" alt="" class="size-full object-contain p-1.5" @error="onError" @load="onLoad" />
