...
{
    protected $signature = 'passkeys:bootstrap {email : The admin account email to generate a login code for}';
    ...
    public function handle(): int
    {
        ...
        if (! $user) {
            $this->error('No admin account found with that email.');
        ...
        $this->line('Expires in 10 minutes. Enter this email and code directly at /admin/login/code.');
